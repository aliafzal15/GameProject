...
public class PlayScreen implements Screen{
    ...
    public void show() {
        ...
        tree = new com.chaowang.ddgame.MapModel.Tree(new Vector2(100, 100),new Vector2(50, 100));
        tree1 = new com.chaowang.ddgame.MapModel.Tree(new Vector2(200, 100),new Vector2(50, 100));
        trees = new ArrayList<com.chaowang.ddgame.MapModel.Tree>();
        trees.add(tree);
        trees.add(tree1);
